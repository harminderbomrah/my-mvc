<html>
  ...
  <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="background-color: #f4f3f9;">
    <table id="ask" width="800" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto">
      <tr>
        <td colspan="3">
          <img src="<?= Request::server_name_with_port() ?>/public/email/edm_01.png" width="800" height="192" alt="" style="display: block;">
        </td>
      </tr>
      <tr>
        <td style="width: 104px;">
          <img src="<?= Request::server_name_with_port() ?>/public/email/edm_02.png" width="104" height="136" alt="" style="display: block;">
        </td>
        <td style="width: 588px; height: 136px; background: url(<?= Request::server_name_with_port() ?>/public/email/edm_03.png) center no-repeat transparent; vertical-align: top;">
        ...
        <td style="width: 108px;">
          <img src="<?= Request::server_name_with_port() ?>/public/email/edm_04.png" width="108" height="136" alt="" style="display: block;">
        </td>
      </tr>
      <tr>
        <td colspan="3" style="background: url(<?= Request::server_name_with_port() ?>/public/email/edm_05.png) center repeat-y transparent;">
              ...
              <?php foreach ($products as $product) { ?>
                <li style="padding: 5px; font-size: 14px; line-height: 30px; float: left; width: 45%; margin-bottom: 1em;">
                  <div style="float: left; width: 30px; height: 30px; overflow: hidden;">
                    <img src="<?= Request::server_name_with_port() . $product['image'] ?>" alt="" style="width: 100%; height: auto;">
                  </div>
                  <a href="<?= Request::server_name_with_port() . end(Routes::url_helper('collections','show',array('id' => $product['id']))) ?>" target="_blank" style="display: inline-block; margin-left: 10px; text-decoration: blink; color: #42AED8;"><?= $product['title'] ?></a>
                </li>
                <?php } ?>
              </ol>
            <?php } ?>
      ...
      <tr>
        <td colspan="3">
          <img src="<?= Request::server_name_with_port() ?>/public/email/edm_06.png" width="800" height="70" alt="" style="display: block;">
        </td>
      </tr>
    </table>
  </body>
