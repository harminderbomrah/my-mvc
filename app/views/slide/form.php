          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group" data-ng-class="{'hide': !initial.publishDate, 'has-error': slideForm.date.$invalid && !slideForm.date.$pristine}">
                <input type="text" name="date" class="form-control" data-ng-model="slideData.date" data-ng-required="initial.publishDate" is-open="opened" min="initial.today" datepicker-popup="yyyy/MM/dd" show-button-bar="false" datepicker-options="dateOptions" />
