...
<section class="main-wrap mini-height border-bottom main-block list-collections">
  <ui class="row list-unstyled">
    ...
    <?php foreach ($products as $product) { ?>
      <li class="list-item col-3 col-lg-2 col-md-4 col-ms-12 col-xs-12" <?php if($product['image']!=""){echo 'style="background-image: url('.$product['image']->to_absolute_url().')"';}?>>
